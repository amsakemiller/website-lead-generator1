...
A comprehensive lead generation tool that combines all steps into a single, easy-to-use GUI application.
...
- `unified_config.json` - Main configuration file (auto-generated)
- `logs/unified_leadgen.log` - Application logs
